...
class StampActivity3 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_stamp3)

        //버튼 클릭시 링크된 사이트로 이동
        val Site_button = findViewById<Button>(R.id.Site_button1)
        Site_button.setOnClickListener {
            var intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://www.museum.go.kr/site/main/home"))
